...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.saveTodo = exports.loadTodos = undefined;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _feature = __webpack_require__(416);
	...
	function renderFilterTop(input, todoList) {
	    return '<div id="app">' + getFilter() + (todoList + '         \n         ' + input + '\n    </div>');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _parseInt = __webpack_require__(418);
	...
	function registerEventHandlers() {
	    ...
	    (0, _events.listen)("load", '#app', function (event) {
	        console.log('load');
	    });
	    ...
	    (0, _events.listen)('change', '#todoInput', function (event) {
	        _state.todos.dispatch((0, _actions.todoInput)(event.target.value));
	    ...
	    (0, _events.listen)('click', '#open', function (event) {
	        var itemsOpen = document.querySelectorAll('.todo__item--open');
	        var itemsClose = document.querySelectorAll('.todo__item--done');

	        itemsOpen.forEach(function (item) {
	            item.classList.remove('close');
	        });
	        itemsClose.forEach(function (item) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $trim = __webpack_require__(422).trim;
	var ws = __webpack_require__(423);
	var hex = /^[-+]?0[xX]/;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var spaces = __webpack_require__(423);
	var space = '[' + spaces + ']';
	var non = '\u200b\u0085';
	var ltrim = RegExp('^' + space + space + '*');
	var rtrim = RegExp(space + space + '*$');
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        case 0:
	                            ...
	                            _context.prev = 2;
	                            _context.next = 5;
	                            return axios.api.saveTodo(todo);

	                        case 5:
	                            success = _context.sent;
	                            return _context.abrupt('return', onSuccess(success));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var task = __webpack_require__(439).set;
	var microtask = __webpack_require__(441)();
	var newPromiseCapabilityModule = __webpack_require__(442);
	var perform = __webpack_require__(443);
	var userAgent = __webpack_require__(444);
	var promiseResolve = __webpack_require__(445);
	var PROMISE = 'Promise';
	var TypeError = global.TypeError;
	var process = global.process;
	var versions = process && process.versions;
	...
	if (!USE_NATIVE) {
	  ...
	  Internal.prototype = __webpack_require__(446)($Promise.prototype, {
	    // 25.4.5.3 Promise.prototype.then(onFulfilled, onRejected)
	    then: function then(onFulfilled, onRejected) {
	      var reaction = newPromiseCapability(speciesConstructor(this, $Promise));
	      reaction.ok = typeof onFulfilled == 'function' ? onFulfilled : true;
	...
	$export($export.S + $export.F * !(USE_NATIVE && __webpack_require__(448)(function (iter) {
	  $Promise.all(iter)['catch'](empty);
	})), PROMISE, {
	  // 25.4.4.1 Promise.all(iterable)
	  all: function all(iterable) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var global = __webpack_require__(347);
	var macrotask = __webpack_require__(439).set;
	var Observer = global.MutationObserver || global.WebKitMutationObserver;
	var process = global.process;
	var Promise = global.Promise;
	var isNode = __webpack_require__(342)(process) == 'process';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var anObject = __webpack_require__(353);
	var isObject = __webpack_require__(354);
	var newPromiseCapability = __webpack_require__(442);
